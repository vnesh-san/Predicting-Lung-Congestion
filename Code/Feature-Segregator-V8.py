...
for yang in range(0,2):
    ...
    subset1_X_train,subset1_X_test,subset1_y_train,subset1_y_test = cross_validation.train_test_split(subset1_X,subset1_y,test_size = 0.30)
        
    subset2_X_train,subset2_X_test,subset2_y_train,subset2_y_test = cross_validation.train_test_split(subset3_X,subset3_y,test_size = 0.30)
        
    subset3_X_train,subset3_X_test,subset3_y_train,subset3_y_test = cross_validation.train_test_split(subset2_X,subset2_y,test_size = 0.30)
    ...
    acc_sub3[yang] = clf_2.score(subset3_X_test, subset3_y_test)
        
    acc[yang] = (acc_sub1[yang]+  acc_sub2[yang] + acc_sub3[yang])/3
...
print((acc_sub1[0]+  acc_sub2[0] + acc_sub3[0] + acc_sub1[1]+  acc_sub2[1] + acc_sub3[1])/6)
